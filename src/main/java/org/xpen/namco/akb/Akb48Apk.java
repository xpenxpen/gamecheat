...
public class Akb48Apk {
    
    private static final Logger LOG = LoggerFactory.getLogger(Akb48Apk.class);

    public static void main(String[] args) throws Exception {
        UserSetting.rootInputFolder = "D:/psp/moe/NoLabel/PSP_GAME/USRDIR/pack";
        UserSetting.rootOutputFolder = "D:/psp/moe/NoLabel/PSP_GAME/USRDIR/pack/myex";
