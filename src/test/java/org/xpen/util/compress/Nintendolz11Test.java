...
public class Nintendolz11Test {
    ...
    public void testLz11() throws IOException {
        File file = new File("D:/soft/ga/nds/Nintendo_DS_Compressors_v1.4-CUE/0834");
        ...
        FileUtils.writeByteArrayToFile(new File("D:/soft/ga/nds/Nintendo_DS_Compressors_v1.4-CUE/0834.out"), outBytes);
    }
